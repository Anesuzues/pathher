      ...
      >
        <div className="px-6 flex items-center justify-between mb-4">
          ...
          <button 
            ...
            className={cn(
              "p-2 text-gray-400 hover:text-purple-600 hover:bg-purple-50 rounded-lg transition-colors",
              !sidebarExpanded && "hidden group-hover:block"
            )}
          >
            <Menu size={20} />
          </button>
        ...
        <div className="px-4 mt-auto">
          <button className={cn(
            "flex items-center gap-4 p-3 text-gray-400 hover:text-purple-600 hover:bg-purple-50 rounded-2xl transition-all w-full",
            isCollapsed ? "justify-center" : ""
          )}>
            <Bell size={24} className="shrink-0" />
            {!isCollapsed && <span className="font-bold">Notifications</span>}
          </button>
        </div>
      </motion.nav>
      ...
      <header className="md:hidden fixed top-0 left-0 right-0 bg-white/80 backdrop-blur-md border-b border-purple-100 z-50 px-4 py-3 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <button 
            ...
            className="p-2 text-gray-500 hover:bg-purple-50 rounded-lg"
          >
            <Menu size={24} />
          </button>
  ...
  return (
    <Router>
      <div className="min-h-screen bg-[#FDF8FF] text-gray-900 font-sans pt-16 md:pt-0">
        ...
        />
        <main className={cn(
          "max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12 transition-all duration-300",
          sidebarExpanded ? "md:pl-[280px]" : "md:pl-[80px]"
        )}>
